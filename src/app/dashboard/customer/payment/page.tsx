// src/app/dashboard/customer/payment/page.tsx
'use client';
...
export default function CustomerPaymentPage() {
  ...
  const fetchOrderDetails = async (orderId: number) => {
    try {
      ...
      if (transaksi) {
        ...
        router.push(`/dashboard/customer/receipt?transaksi=${transaksi.id_transaksi}`);
        return;
      }
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        router.push(`/dashboard/customer/receipt?transaksi=${response.transaksi.id_transaksi}`);
      }, 3000);

      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">Review dan konfirmasi pesanan pelanggan</p>
            </div>
          </div>
          <Button
            onClick={() => router.push('/dashboard/waiter/menu')}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2">
            <Card title={`Keranjang Pesanan (${items.length} item)`}>
              {items.length === 0 ? (
                ...
                <div className="space-y-3">
                  {items.map((item) => (
                    ...
                    >
                      <div className="w-20 h-20 bg-gradient-to-br from-orange-400 to-orange-600 rounded-lg flex items-center justify-center text-3xl">
                        🍽️
                      </div>
                      <div className="flex-1">
                        <h3 className="font-bold text-gray-800 text-lg">{item.nama_masakan}</h3>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="w-12 text-center font-bold text-lg">{item.jumlah}</span>
                        <Button
                          size="sm"
                          onClick={() => updateQuantity(item.id_masakan, item.jumlah + 1)}
                          disabled={loading}

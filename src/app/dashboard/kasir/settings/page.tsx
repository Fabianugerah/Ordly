        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-3">
            ...
            {activeTab === 'appearance' && (
              <Card title="Pengaturan Tampilan" className="border border-neutral-800">
                <div className="space-y-6">
                  <div>
                    <h3 className="font-semibold text-neutral-900 dark:text-white mb-4">Theme</h3>
                    <div className="grid grid-cols-2 gap-4">
                      <button
                        onClick={handleThemeToggle}
                        className={`p-6 border-2 rounded-xl transition-all ${
                          !isDarkMode
                            ? 'border-orange-500 bg-blue-50 dark:bg-orange-900/20'
                            : 'border-neutral-200 dark:border-neutral-800 hover:border-neutral-300 dark:hover:border-neutral-600'
                        }`}
                      >
                        <div className="flex flex-col items-center gap-3">
                          <div className="w-16 h-16 bg-white dark:bg-neutral-800 rounded-lg shadow-md flex items-center justify-center">
                      ...
                      >
                        <div className="flex flex-col items-center gap-3">
                          <div className="w-16 h-16 bg-neutral-900 rounded-lg shadow-md flex items-center justify-center">
                  ...
                  <div className="p-4 bg-neutral-50 dark:bg-neutral-800 rounded-lg">
                    <p className="text-sm text-neutral-600 dark:text-neutral-400">
                      💡 Theme akan otomatis tersimpan dan diterapkan saat Anda membuka aplikasi kembali.
                    </p>
                  </div>
                </div>
              </Card>

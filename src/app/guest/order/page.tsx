// src/app/guest/order/page.tsx (FIXED)
'use client';
...
export default function CustomerOrderPage() {
  ...
  const handleSubmitOrder = async () => {
    ...
    try {
      // FIXED: Get guest user ID (user "customer" harus sudah dibuat di database)
      ...
      const orderData = {
        ...
        id_user: guestUser.id_user, // FIXED: Add id_user to order
      };
  ...
  return (
    <div className="min-h-screen bg-neutral-950 px-4 md:px-8 py-8 space-y-8">
          ...
          <Card>
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center gap-4">
                ...
                >
                  <RefreshCw className={`w-5 h-5 text-neutral-600 dark:text-neutral-400 ${loadingTables ? 'animate-spin' : ''}`} />
                </button>
                <div className="flex items-center gap-4 text-sm">
                  <div className="flex items-center gap-2">
                    <div className="w-4 h-4 rounded bg-white dark:bg-neutral-800 border-2 border-neutral-300 dark:border-neutral-600"></div>
                    <span className="text-neutral-600 dark:text-neutral-400">Tersedia</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-4 h-4 rounded bg-orange-500"></div>
                    <span className="text-neutral-600 dark:text-neutral-400">Dipilih</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-4 h-4 rounded bg-neutral-200 dark:bg-neutral-700"></div>
                    <span className="text-neutral-600 dark:text-neutral-400">Terisi</span>
                  </div>
                </div>
              </div>
            </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <Users className={`w-6 h-6 mb-1 ${isSelected ? 'text-white' :
                          table.status === 'terisi' ? 'text-neutral-400 dark:text-neutral-500' :
          ...
          <Card title={`Keranjang Belanja (${items.length} item)`}>
            {items.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-neutral-500 dark:text-neutral-400 mb-4">Keranjang Anda masih kosong</p>
              ...
              <div className="space-y-3">
                {items.map((item) => (
                  <div
                    key={item.id_masakan}
                    className="flex items-start gap-4 p-4 border border-neutral-200 dark:border-neutral-700 rounded-lg hover:shadow-md transition-shadow"
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="font-bold text-neutral-800 dark:text-white text-lg">
                        {item.nama_masakan}
                      </h3>
                    ...
                    <div className="flex flex-col items-center gap-2">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="w-12 text-center font-bold text-lg text-neutral-800 dark:text-white">
                          {item.jumlah}
                        </span>
                        <Button
                          size="sm"
        ...
        <div>
          <Card title="Detail Pesanan">
            <div className="space-y-4">
              <div className="p-4 bg-gradient-to-r from-orange-50 to-blue-50 dark:from-orange-900/20 dark:to-blue-900/20 rounded-lg border border-neutral-200 dark:border-neutral-700">
                <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-1">Nomor Meja <span className="text-red-500">*</span></p>
                {selectedTable ? (
                  <div className="flex items-center gap-2">
                  ...
                  <p className="text-sm text-neutral-500 dark:text-neutral-400 italic">Silakan pilih meja di atas</p>
                )}
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  disabled={loading}
                  className="w-full px-4 py-2 border border-neutral-300 dark:border-neutral-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary disabled:bg-neutral-100 dark:disabled:bg-neutral-800 resize-none bg-white dark:bg-neutral-800 text-neutral-900 dark:text-white"
                />
              </div>

              <div className="border-t border-neutral-200 dark:border-neutral-700 pt-4 space-y-3">
                <div className="flex justify-between text-sm">
                  <span className="text-neutral-600 dark:text-neutral-400">Jumlah Item</span>
                ...
                <div className="flex justify-between text-sm border-t border-neutral-200 dark:border-neutral-700 pt-3">
                  <span className="text-neutral-600 dark:text-neutral-400">Pajak & Service</span>
                  <span className="font-semibold text-green-600">Gratis</span>
                </div>
                <div className="flex justify-between items-center text-lg font-bold border-t border-neutral-200 dark:border-neutral-700 pt-3">
                  <span className="text-neutral-800 dark:text-white">Total Pembayaran</span>
